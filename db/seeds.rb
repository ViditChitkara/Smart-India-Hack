...
QuotationItem.create!([
                          ...
                          {item_id: Item.all[1].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: 0, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[5].id,quantity:500,unit:'gm'},
                          {item_id: Item.all[2].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: 0, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[6].id,quantity:1,unit:'KG'},
                          {item_id: Item.all[3].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: 0, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[7].id,quantity:1,unit:'KG'},
                          {item_id: Item.all[4].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:500,unit:'gm'},
                          {item_id: Item.all[5].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:500,unit:'gm'},
                          {item_id: Item.all[6].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:500,unit:'gm'},
                          {item_id: Item.all[7].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:1,unit:'No'},
                          {item_id: Item.all[8].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:1,unit:'No'},
                          {item_id: Item.all[9].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:1,unit:'Kg'},
                          {item_id: Item.all[10].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:1,unit:'No'},
                          {item_id: Item.all[11].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[4].id,quantity:1,unit:'kg'},
                          {item_id: Item.all[12].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[5].id,quantity:1,unit:'lt'},
                          {item_id: Item.all[13].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[5].id,quantity:500,unit:'gm'},
                          {item_id: Item.all[14].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[5].id,quantity:1,unit:'kg'},
                          {item_id: Item.all[15].id, shop_id: nil, scheduled_time: nil, specification_id: nil, special_code: nil, shop_code: nil, remarks: nil, current_price: nil, user_id: nil, price: nil, quotation_id: Quotation.all[5].id,quantity:500,unit:'gm'}
                      ])
